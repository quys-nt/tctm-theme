  ...
  <section class="c-article__detail">
    <div class="l-container">
      <div class="c-article__inner01">
        <div class="p-archive__cats--intro c-text__white01"><span class="p-archive__cats--date"><?php the_date(); ?></span></div>
      ...
      <div class="c-article__thumbnail">
        ...
        if($thumbnail):
        ?>
        <img src="<?php echo $thumbnail ? $thumbnail : ""; ?>" alt="<?php echo get_post_meta(get_post_thumbnail_id(), '_wp_attachment_image_alt', true); ?>" title="<?php echo get_post_meta(get_post_thumbnail_id(), '_wp_attachment_image_alt', true); ?>" loading="lazy">
        <?php endif;?>
      </div>
      <div class="c-article__inner01">
